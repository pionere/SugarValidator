function validate(fileData, localStorage = {}) {
    ...
    function checkCssInScript() {
        ...
        for (const passage of passages) {
            ...
            let index = 0;
            while (true) {
                index = indexOfTag(html, 'div', index);
                if (index == -1) {
                    break;
                }
                ...
                if (clz) {
                    ...
                    if (msg != '') {
                        msg = msg.substring(2);
                        addWarning([[errorMsgAt(`Unrecognized div-class(es) '${msg}' referenced at `, passage, index)]], passage.header);
                    }
                }
                ...
                if (id) {
                    if (cssIds.has(id)) {
                        ...
                        addWarning([[errorMsgAt(`Unrecognized div-id referenced at `, passage, index)]], passage.header);
                    }
                }
                index = end;
            }
