function validate(fileData, localStorage = {}) {
    ...
    while (true) {
        ...
        if (endIndex === -1 || contentIndex === -1) {
            addHtmlError(htmlErrorAt('Unclosed passage found: ', fileData, startIndex), 'passages');
            break;
        }
    ...
    function checkCssInScript() {
        ...
        if (endIndex === -1 || contentIndex === -1) return addHtmlError(htmlErrorAt('Unclosed stylesheet found: ', fileData, startIndex), 'user-stylesheet');
        ...
        while (true) {
            ...
            if (end == -1) {
                return addHtmlError(errorMsgAt('Unclosed css found: ', style, start), style.header);
            }
