function validate(fileData, localStorage = {}) {
    ...
    function checkCssInScript() {
        ...
        {
            const twcs = ['error-toggle', 'enabled', 'error', 'error-source', 'error-view', 'debug', 'hidden', 'link-external', 'link-visited', 'link-broken', 'link-external', 'marked', 'verbatim', 'link-image',
